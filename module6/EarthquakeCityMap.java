...
public class EarthquakeCityMap extends PApplet {
	...
	//HashMap to store life expectancy
	...
	public void setup() {		
	    ...
	    //Print out the top earthquakes by magnitude
	    sortAndPrint(20);
	...
	private void addKey() {	
		...
		textAlign(LEFT, CENTER);
		textSize(12);
		text("LifeExpectancy Key", xbase+25, ybase+260);
		
		fill(210,100,45);
		rect(xbase+25,ybase+275,10,10);
		
		fill(100,100,165);
		rect(xbase+25,ybase+295,10,10);
		
		fill(55,100,190);
		rect(xbase+25,ybase+315,10,10);
		
		fill(0,0,0);
		text("Low-Near 40",xbase+45,ybase+280);
		text("Average-Near 60",xbase+45,ybase+300);
		text("High-Near 90", xbase+45,ybase+320);
	...
	/**Sort and Print Earthquakes in reverse order of magnitude */
		...
		private void shadeCountries() {
			for (Marker marker : countryMarkers) {
				...
				if (lifeExpMap.containsKey(countryId)) {
					...
					//System.out.println("LifeExpectancy = " + lifeExp + " ColorLevel =" + colorLevel);
